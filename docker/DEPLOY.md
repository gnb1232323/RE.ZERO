...
Первый запуск соберёт образ и поднимет три контейнера: базу данных, приложение и Caddy
(автоматический HTTPS). Приложение само применит миграции базы при старте.
